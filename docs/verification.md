...
| `uv run --isolated python scripts/evaluate_assistant.py --split all --output docs/assistant/eval-results.json` | Clean-tree report at `3777936717f49cbdb02f31348d8331ce09f7f4ed`: 32 cases, 25 scored, mean recall@4 0.96; development 1.00, held-out 0.9091; retrieval p50 17.402 ms, p95 22.645 ms; one real offline explanation 3382.602 ms with citation, numeric and source consistency checks true. Human grounding and live provider remain unverified. |
